...
then
   tee -a /etc/sysconfig/network-scripts/ifcfg-eth0 <<-EOF
	...
	IPV6_FAILURE_FATAL=no
	IPV6_ADDR_GEN_MODE=stable-privacy
	IPV6ADDR=2403:6a40:2:1700::$IPD:0000/56
...
then
   tee -a /etc/sysconfig/network-scripts/ifcfg-eth0 <<-EOF
	...
	IPV6_FAILURE_FATAL=no
	IPV6_ADDR_GEN_MODE=stable-privacy
	IPV6ADDR=2403:6a40:2:3100::$IPD:0000/56
	IPV6_DEFAULTGW=2403:6a40:2:3100::1
	EOF
elif [ $IPC == 4 ]
then
   tee -a /etc/sysconfig/network-scripts/ifcfg-eth0 <<-EOF
...
then
   tee -a /etc/sysconfig/network-scripts/ifcfg-eth0 <<-EOF
	...
	IPV6_FAILURE_FATAL=no
	IPV6_ADDR_GEN_MODE=stable-privacy
	IPV6ADDR=2403:6a40:2:9100::$IPD:0000/56
	IPV6_DEFAULTGW=2403:6a40:2:9100::1
	EOF
elif [ $IPC == 89 ]
then
   tee -a /etc/sysconfig/network-scripts/ifcfg-eth0 <<-EOF
	...
	IPV6_FAILURE_FATAL=no
	IPV6_ADDR_GEN_MODE=stable-privacy
	IPV6ADDR=2403:6a40:2:8900::$IPD:0000/56
	IPV6_DEFAULTGW=2403:6a40:2:8900::1
	EOF
elif [ $IPC == 12 ]
then
   tee -a /etc/sysconfig/network-scripts/ifcfg-eth0 <<-EOF
...
then
   tee -a /etc/sysconfig/network-scripts/ifcfg-eth0 <<-EOF
	...
	IPV6_FAILURE_FATAL=no
	IPV6_ADDR_GEN_MODE=stable-privacy
	IPV6ADDR=2403:6a40:2:9000::$IPD:0000/56
	IPV6_DEFAULTGW=2403:6a40:2:9000::1
	EOF
else
